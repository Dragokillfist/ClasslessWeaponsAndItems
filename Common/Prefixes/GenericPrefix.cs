...
namespace ClasslessWeaponsAndItems.Common.Prefixes
{
    ...
    public class GenericPrefix : ModPrefix
    {
        ...
        public virtual float Generic => 1f;
        ...
        {
           damageMult *= 1f + 0.20f * Generic;
        }
        public override void ModifyValue(ref float valueMult) {
            valueMult *= 1f + 0.05f * Generic;
        }
        ...
        public override IEnumerable<TooltipLine> GetTooltipLines(Item item) {
            ...
            yield return new TooltipLine(Mod, "PrefixWeaponAwesome", PowerTooltip.Format(Generic)) {
