...
namespace ClasslessWeaponsAndItems.Content.Projectiles
{
	...
	public class SlimeBall : ModProjectile
	{
		...
		public override string Texture => "ClassLessWeaponsAndItems/Content/Items/SlimeFist"; // Use texture of item as projectile texture
		...
		public override void SetDefaults() {
			...
			Projectile.DamageType = DamageClass.Generic; // Projectile is a melee projectile
		}
